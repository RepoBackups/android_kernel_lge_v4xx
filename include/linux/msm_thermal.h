...
struct msm_thermal_stat {
	...
	uint32_t hotplug_temp_degC;
	uint32_t hotplug_temp_hysteresis_degC;
	uint32_t core_control_mask;
	uint32_t freq_mitig_temp_degc;
	uint32_t freq_mitig_temp_hysteresis_degc;
	uint32_t freq_mitig_control_mask;
	uint32_t freq_limit;
	uint32_t vdd_rstr_temp_degC;
	uint32_t vdd_rstr_temp_hyst_degC;
	uint32_t psm_temp_degC;
	uint32_t psm_temp_hyst_degC;
	uint32_t ocr_temp_degC;
	uint32_t ocr_temp_hyst_degC;
	uint32_t therm_reset_temp_degC;
};
#endif
